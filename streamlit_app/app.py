...
st.set_page_config(page_title="Personal AI Analyst", layout="wide", page_icon="📊")
...
pg = st.navigation([st.Page("pages/1_📊_Overview.py", title="Overview", icon="📊"),
    st.Page("pages/2_📁_Upload.py", title="Upload", icon="📁"),
    st.Page("pages/3_📈_Analysis.py", title="Analysis", icon="📈")])
pg.run()
